...
const BuktiTransferIwkSchema = new mongoose.Schema({
  ...
  iuran_wajib: { type: mongoose.Schema.Types.ObjectId, ref: 'IuranWajib', default: null },
  ...
  cek_no_rumah_sesuai: { type: Boolean, default: false },
  validasi_catatan_transfer: { type: Boolean, default: true },
  catatan_transfer: { type: String, default: '' },
